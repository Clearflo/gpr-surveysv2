/*
  # Fix booking status update issues
  
  1. Changes
    - Update the booking availability check function to properly consider cancellations
    - Improve status update trigger functions
    - Add proper indexes for status-based queries
    - Fix potential race conditions in status updates
